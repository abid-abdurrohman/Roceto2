...
<main id="tournament">
      ...
      if ($count == 0) {
          ...
          while ($row = mysqli_fetch_array($result)) {
            ...
            $sql2 = "SELECT match_teams.id, match_teams.score, participants.nama_tim FROM matches INNER JOIN match_teams ON matches.id=match_teams.match_id
              INNER JOIN participants ON participants.id=match_teams.participant_id WHERE matches.event_id=$events->id AND matches.id=$id_match";
 ...
 <?php
     ...
     $count = mysqli_num_rows($result);
     if ($count == 0) {
         $sql4 = "SELECT * FROM matches WHERE matches.event_id=$events->id AND matches.no_match=1";
         ...
         if ($count4 == 1) {
             ...
             $sql3 = "SELECT match_teams.score, participants.nama_tim FROM matches INNER JOIN match_teams ON matches.id=match_teams.match_id
               INNER JOIN participants ON participants.id=match_teams.participant_id WHERE match_teams.status='win' AND matches.event_id=$events->id AND matches.no_match=1";
 ...
 <?php
     ...
     $count = mysqli_num_rows($result);
     if ($count == 0) {
         $sql4 = "SELECT * FROM matches WHERE matches.event_id=$events->id AND matches.no_match=2";
         $result4 = mysqli_query($con, $sql4);
         $count4 = mysqli_num_rows($result4);
         if ($count4 == 1) {
             echo "<ul class='round round-3'>";
             $sql3 = "SELECT match_teams.score, participants.nama_tim FROM matches INNER JOIN match_teams ON matches.id=match_teams.match_id
               INNER JOIN participants ON participants.id=match_teams.participant_id WHERE match_teams.status='win' AND matches.event_id=$events->id AND matches.no_match=2";
             $result3 = mysqli_query($con, $sql3);
             $count3 = mysqli_num_rows($result3);
             if ($count3 == 1) {
               while ($row3 = mysqli_fetch_array($result3)) {
 ...
 <?php
     ...
     $count = mysqli_num_rows($result);
     if ($count == 0) {
         $sql4 = "SELECT * FROM matches WHERE matches.event_id=$events->id AND matches.no_match=3";
         $result4 = mysqli_query($con, $sql4);
         $count4 = mysqli_num_rows($result4);
         if ($count4 == 1) {
             echo "<ul class='round round-4'>";
             $sql3 = "SELECT match_teams.score, participants.nama_tim FROM matches INNER JOIN match_teams ON matches.id=match_teams.match_id
               INNER JOIN participants ON participants.id=match_teams.participant_id WHERE match_teams.status='win' AND matches.event_id=$events->id AND matches.no_match=3";
             $result3 = mysqli_query($con, $sql3);
             $count3 = mysqli_num_rows($result3);
             if ($count3 == 1) {
               while ($row3 = mysqli_fetch_array($result3)) {
...
<?php
    ...
    $count = mysqli_num_rows($result);
    if ($count == 0) {
        $sql4 = "SELECT * FROM matches WHERE matches.event_id=$events->id AND matches.no_match=4";
        $result4 = mysqli_query($con, $sql4);
        $count4 = mysqli_num_rows($result4);
        if ($count4 == 1) {
            echo "<ul class='round round-5'>";
            $sql3 = "SELECT match_teams.score, participants.nama_tim FROM matches INNER JOIN match_teams ON matches.id=match_teams.match_id
              INNER JOIN participants ON participants.id=match_teams.participant_id WHERE match_teams.status='win' AND matches.event_id=$events->id AND matches.no_match=4";
            $result3 = mysqli_query($con, $sql3);
            $count3 = mysqli_num_rows($result3);
            if ($count3 == 1) {
              while ($row3 = mysqli_fetch_array($result3)) {
...
?>
<?php
    $sql = "SELECT * FROM matches WHERE matches.event_id=$events->id AND matches.no_match=6";
    $result = mysqli_query($con, $sql);
    $count = mysqli_num_rows($result);
    if ($count == 0) {
        $sql4 = "SELECT * FROM matches WHERE matches.event_id=$events->id AND matches.no_match=5";
        $result4 = mysqli_query($con, $sql4);
        $count4 = mysqli_num_rows($result4);
        if ($count4 == 1) {
            echo "<ul class='round round-6'>";
            $sql3 = "SELECT match_teams.score, participants.nama_tim FROM matches INNER JOIN match_teams ON matches.id=match_teams.match_id
              INNER JOIN participants ON participants.id=match_teams.participant_id WHERE match_teams.status='win' AND matches.event_id=$events->id AND matches.no_match=5";
            $result3 = mysqli_query($con, $sql3);
            $count3 = mysqli_num_rows($result3);
            if ($count3 == 1) {
              while ($row3 = mysqli_fetch_array($result3)) {
