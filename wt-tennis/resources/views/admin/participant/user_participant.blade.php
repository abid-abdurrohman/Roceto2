...
@section('title', 'Detail User Participant')
@section('content')
...
<!--venobox lightbox-->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">User Participant</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="#">Admin</a></li>
                        <li><a href="{{ action('ParticipantController@event_index', $user->user_id) }}">Participant User</a></li>
                                        ...
                                        <div class="col-md-10 col-sm-10">
                                          <div class="table table-responsive">                              
                                            <table class="table table-hover">
                                                ...
                                                <tr colspan="3">
                                                    <td><center><a href="{{ action('ParticipantController@bukti_pembayaran', [ $user->id ]) }}" class="btn btn-info" >Check</a></center></td>
                                                </tr>
                                            </table>
                                          </div>
                                        </div>
        ...
        <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Data Participant</h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                              <div class="table-responsive">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        @foreach ($participants as $participant)
                                            <tr>
                                                ...
                                                <td><a href="{{ action('ParticipantController@show', [$user->id, $participant->id]) }}"> {{ $participant->nama_tim}}</a></td>
                                                ...
                                                @endif 
                                               <td>
                                                    <a href="{{ action('ParticipantController@edit', [ $user->id, $participant->id]) }}" class="fa fa-trash"> Edit</a>
                                                </td>
                                               <td>
