      ...
      <div class="row">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title">Data {{$participants->nama}} Players</h3>
              </div>
              <div class="panel-body">
                <a href="{{ action('MemberController@create', [$user->id, $participants->id]) }}" class="btn btn-primary waves-effect waves-light">Add <i class="fa fa-plus"></i></a>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{ $member->id }}</td>
                          <td>
                            <a href="{{ action('MemberController@show', [$user->id, $participants->id, $member->id]) }}">
                              {{ $member->nama }}
                            </a>
                          </td>
                          ...
                          <td>
                            <a href="{{ action('MemberController@edit', [$user->id, $participants->id, $member->id]) }}">
                              <i class="fa fa-edit"></i> Edit
                            </a>
                          </td>
                          <td>
                            <a href="#" data-toggle="modal" data-target="#myModal-{{ $user->id }}-{{ $participants->id }}-{{ $member->id }}">
