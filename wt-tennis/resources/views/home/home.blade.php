             ...
             <ul id="product" class="bxslider">
                ...
                <div class="jm-item second">
                    <div class="jm-item-wrapper">
                        <div class="jm-item-image">
                            <img src="images\pertandingan\futsalball.jpg" alt="" />
                 ...
                 <div class="product-title"><a href="details_prod.html" ><span>Futsal</span></a><p class="prod-ts-price">12 Grup</p></div>
              ...
              <li>
                  <div class="jm-item second">
                    <div class="jm-item-wrapper">
                        <div class="jm-item-image">
                            <img src="images\pertandingan\basketball.jpg" alt="" />
                            <div class="jm-item-description">
                                    <div class="jm-item-button">
                  ...
                  <div class="product-title"><a href="details_prod.html" ><span>Basket</span></a><p class="prod-ts-price">10 Grup</p></div>
              ...
              <li>
                  <div class="jm-item second">
                    <div class="jm-item-wrapper">
                        <div class="jm-item-image">
                            <img src="images\pertandingan\kok.jpg" alt="" />
                            <div class="jm-item-description">
                                    <div class="jm-item-button">
                                        <a href="details_prod.html"><i class="fa fa-chain-broken"></i></a>
                                    </div>
                  ...
                  <div class="product-title"><a href="details_prod.html" ><span>Bulu Tangkis</span></a><p class="prod-ts-price">8 Grup</p></div>
              ...
              <li>
                 <div class="jm-item second">
                    <div class="jm-item-wrapper">
                        <div class="jm-item-image">
                            <img src="images\pertandingan\voliball.jpg" alt="" />
                            <div class="jm-item-description">
                                    <div class="jm-item-button">
                                        <a href="details_prod.html"><i class="fa fa-chain-broken"></i></a>
                                    </div>
                 ...
                 <div class="product-title"><a href="details_prod.html"><span> Volly</span></a><p class="prod-ts-price">8 Grup</p></div>
              ...
              <li>
                 <div class="jm-item second">
                    <div class="jm-item-wrapper">
                        <div class="jm-item-image">
                            <img src="images\pertandingan\swim.jpg" alt="" />
                            <div class="jm-item-description">
                                    <div class="jm-item-button">
                                        <a href="details_prod.html"><i class="fa fa-chain-broken"></i></a>
                                    </div>
                 ...
                 <div class="product-title"><a href="details_prod.html" ><span>Berenang</span></a><p class="prod-ts-price">10 Grup</p></div>
              ...
              <li>
                 <div class="jm-item second">
                    <div class="jm-item-wrapper">
                        <div class="jm-item-image">
                            <img src="images\pertandingan\maraton.jpg" alt="" />
                            <div class="jm-item-description">
                                    <div class="jm-item-button">
                                        <a href="details_prod.html"><i class="fa fa-chain-broken"></i></a>
                                    </div>
                    ...
                    <div class="product-title"><a href="details_prod.html" ><span>Marathon</span></a><p class="prod-ts-price">10 Grup</p></div>
              ...
              <li>
                 <div class="jm-item second">
                    <div class="jm-item-wrapper">
                        <div class="jm-item-image">
                            <img src="images\pertandingan\catur.jpg" alt="" />
                            <div class="jm-item-description">
                                    <div class="jm-item-button">
                                        <a href="details_prod.html"><i class="fa fa-chain-broken"></i></a>
                                    </div>
                 ...
                 <div class="product-title"><a href="details_prod.html" ><span>Catur</span></a><p class="prod-ts-price">10 Orang</p></div>
              ...
              <li>
                 <div class="jm-item second">
                    <div class="jm-item-wrapper">
                        <div class="jm-item-image">
                            <img src="images\pertandingan\lompat-tinggi.jpg" alt="" />
                            <div class="jm-item-description">
                                    <div class="jm-item-button">
                                        <a href="details_prod.html"><i class="fa fa-chain-broken"></i></a>
                                    </div>
                 ...
                 <div class="product-title"><a href="details_prod.html" ><span>Lompat Tinggi</span></a><p class="prod-ts-price">10 Orang</p></div>
