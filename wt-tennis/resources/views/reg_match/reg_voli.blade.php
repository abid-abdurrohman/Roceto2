...
<section class="drawer">
  ...
  <section id="shop" class="container secondary-page">
     ...
     <div class="top-score-title col-md-9">
      ...
      <div class="col-md-12 content-zoom">
        <div class="col-md-6 content-img-zoom">
         <img id="img_01" src="images\pertandingan\voliball.jpg" width="400" height="340" />
       </div>
    ...
    <div class="col-md-12 content-more-det login-page">
      <h3>Register Now</h3>
        <form method="post" class="register-form" role="form" action="{{ action('RegisterController@store_regVoli') }}">
        {{ csrf_field() }}
