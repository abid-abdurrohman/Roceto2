  ...
  <section id="shop" class="container secondary-page">
    <div class="general general-results">
     <div class="top-score-title col-md-9">
      <h3> Kategori Lomba <span>{{ $event->nama }}</span> - <span>{{ $category->nama }}</span><span class="point-little">.</span></h3>
      <div class="col-md-12 content-zoom">
        <div class="col-md-6 content-img-zoom">
         <img id="img_01" src="{!! asset('').'/'.$category->thumbnail !!}" width="400" height="340" />
       </div>
       <div class="col-md-6 content-desc-zoom">
         <h3>{{ $event->nama }}</h3>
         <p class="desc-prod" style="text-align:justify">
           <b>Perlombaan {{ $event->nama }}</b> {{ $event->detail }}</p>
       </div>
    </div>
     ...
     <div class="panel-body" style="padding-top:100px">
       <div class="general general-results tournaments">
         <div id="c-calend" class="top-score-title right-score col-md-12">
           <div class="accordion accordion-close" id="section11"><i class="fa fa-calendar-o"></i>Peraturan Perlombaan {{ $event->nama }}<span></span>
           </div>
           <div class="acc-content" style="display: block;">
            <div>Aturan dasar pada permainan {{ $event->nama }} adalah sebagai berikut:</div>
            <li class="desc-prod" style="text-align:justify; margin-left:10px;">{!! $category->peraturan !!}</li>
          </div>

          <div class="accordion accordion-close" id="section11"><i class="fa fa-calendar-o"></i>Biaya Pendaftaran {{ $event->nama }}<span></span>
           </div>
           <div class="acc-content" style="display: block;">
            <div>Biaya Pendaftaran perlombaan {{ $event->nama }} adalah : </div>
            <li class="desc-prod" style="text-align:justify">Rp. {{ $category->biaya_pendaftaran }}</li>
          </div>

          <div class="accordion accordion-close" id="section11"><i class="fa fa-calendar-o"></i>Kuota Perlombaan {{ $event->nama }}<span></span>
           </div>
           <div class="acc-content" style="display: block;">
            <div>Kuota</div>
            <li class="desc-prod" style="text-align:justify">{{ $category->kuota }} tim</li>
          </div>
